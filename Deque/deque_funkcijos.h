...
extern deque<std::chrono::duration<double>> testuLaikai;
extern deque<std::chrono::duration<double>> kurimoLaikai;
extern deque<std::chrono::duration<double>> rusiavimoLaikai;
extern deque<std::chrono::duration<double>> kietekuLaikai;
extern deque<std::chrono::duration<double>> vargsiukuLaikai;
